...
const DisabledStores = ({ stores }) => {
  ...
  const enableStore = (storeName) => {
    axios
      .patch(
        `https://jenifa-stores.herokuapp.com/admin/enable/${storeName}`,
        "",
        { headers: { Authorization: `${token}` } }
      )
      .then((res) => {
        console.log(res.data);
        setMessage("Store Enabled Successfully");
        setAl(true);
        setTimeout(() => {
      ...
      .catch((error) => {
        console.log(error);
        setMessage("Store Enablement Failed");
        setAl(true);
        setSeverity("error");
        setTimeout(() => {
          window.location.reload(false);
  ...
  return (
    <div>
      <SearchBox searchChange={searchChange} place="Search By Store Name..." />
      {al ? (
        <>
              ...
              <Table aria-label="customized table">
                <TableHead className={classes.head}>
                  <TableRow>
                    ...
                    <TableCell className={classes.text}>Location</TableCell>
                ...
                <TableBody>
                  {(rowsPerPage > 0
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        {store.enabled === false && (
                          <Chip label="Disabled" style={{ color: "#c62828" }} />
                        )}
                      </TableCell>
                      <TableCell>
                        <Button
