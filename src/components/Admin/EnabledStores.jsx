...
const EnabledStored = ({ stores }) => {
  ...
  const disableStore = (storeName) => {
    axios
      .put(
        `https://jenifa-stores.herokuapp.com/admin/disable/${storeName}`,
        "",
